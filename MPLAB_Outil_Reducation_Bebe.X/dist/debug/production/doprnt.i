...
# 416 "C:\\Program Files\\Microchip\\xc8\\v2.20\\pic\\sources\\c90\\common\\doprnt.c"
static double
 ...
 *ap = __va_start();
 ...
 while((c = *f++)) {
  ...
  flag = 0;
# 614 "C:\\Program Files\\Microchip\\xc8\\v2.20\\pic\\sources\\c90\\common\\doprnt.c"
  ...
  if(*f == '.') {
   flag |= 0x4000;
   f++;
# 644 "C:\\Program Files\\Microchip\\xc8\\v2.20\\pic\\sources\\c90\\common\\doprnt.c"
   {
    prec = 0;
    while(isdigit((unsigned)*f)) {
     prec *= 10;
  ...
  case 0:
   goto alldone;
# 688 "C:\\Program Files\\Microchip\\xc8\\v2.20\\pic\\sources\\c90\\common\\doprnt.c"
  case 'f':
   flag |= 0x400;
   break;
...
# 1138 "C:\\Program Files\\Microchip\\xc8\\v2.20\\pic\\sources\\c90\\common\\doprnt.c"
     if(prec <= 12)
    ...
    if(flag & 0x03)
     width--;
# 1201 "C:\\Program Files\\Microchip\\xc8\\v2.20\\pic\\sources\\c90\\common\\doprnt.c"
    {
...
# 1407 "C:\\Program Files\\Microchip\\xc8\\v2.20\\pic\\sources\\c90\\common\\doprnt.c"
  if(width > c)
   width -= c;
  else
   width = 0;
